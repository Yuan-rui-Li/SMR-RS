...
from ....ops.carafe import CARAFEPack
from ....base_modules import BaseModule, ModuleList
from ....runner import   auto_fp16, force_fp32
...
class FCNMaskHead(BaseModule):
    ...
    def forward(self, x):
        ...
        if self.upsample is not None:
            ...
            if self.upsample_method == 'deconv':
                x = self.relu(x)
        #通过此次卷积，输出tensor的chanel数为1或为num_classes
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
                      ori_shape, scale_factor, rescale, return_mask_tensor_gpu=True):
