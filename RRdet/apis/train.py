...
from ..runner import (DistSamplerSeedHook, EpochBasedRunner,
                         Fp16OptimizerHook, OptimizerHook, build_runner,
                         get_dist_info)
from ..core import DistEvalHook, EvalHook, build_optimizer
from ..datasets import (build_dataloader, build_dataset,
                            replace_ImageToTensor)
from ..utils import (build_ddp, build_dp, compat_cfg,
...
def train_detector(model,
    ...
    #workflow有多少个元组,data_loaders列表就有多少个dataset
    ...
    #workflow有多少个元组,data_loaders列表就有多少个dataset也即有多少个data_loader
